...
namespace OrbitTunerUiPlugin
{
    ...
    public class CSharpPlugin : IAgUiPlugin, IAgUiPluginCommandTarget
    {
        ...
        public void OnDisplayContextMenu(IAgUiPluginContextMenuBuilder MenuBuilder)
        {
            if (m_integrate)
            {
        ...
        public void OnDisplayMenu(string MenuTitle, AgEUiPluginMenuBarKind MenuBarKind, IAgUiPluginMenuBuilder MenuBuilder)
        {
            stdole.IPictureDisp picture;
            string imageResource = "OrbitTunerUiPlugin.STK.ico";
            Assembly currentAssembly = Assembly.GetExecutingAssembly();
        ...
        public void OnDisplayMenu(string MenuTitle, AgEUiPluginMenuBarKind MenuBarKind, IAgUiPluginContextMenuBuilder MenuBuilder)
        {
